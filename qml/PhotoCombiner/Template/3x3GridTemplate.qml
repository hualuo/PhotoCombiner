...
BasePage {
    ...
    Template {
        ...
        BaseRoundedPhoto {
            id: photo1
            x: 10; y: 10
            width: 149; height: 202;
            source: photoModel.get(0).fileName
        }
        BaseRoundedPhoto {
            id: photo2
            x: 165; y: 10
            width: 150; height: 202;
    ...
    transitions: [
        Transition {
            ...
            PropertyAnimation { target: photo3; property: "y"; duration: Math.random() * 800 + 500 }
            ...
            PropertyAnimation { target: photo9; property: "y"; duration: Math.random() * 800 + 500 }
            PropertyAnimation { target: photo9; property: "opacity"; duration: Math.random() * 800 + 500 }
        }
    ]
}
