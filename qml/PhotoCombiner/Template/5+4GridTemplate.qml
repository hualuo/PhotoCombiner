...
BasePage {
    ...
    Template {
        ...
        BaseRoundedPhoto {
            id: photo1
            x: 10; y: 10
            width: 111; height: 131;
            source: photoModel.get(0).fileName
        }
        BaseRoundedPhoto {
            id: photo2
            x: 127; y: 10
            width: 110; height: 131;
