...
BasePage {
    ...
    states: [
        State {
            name: "DEFAULT"
            PropertyChanges { target: photo1; y: -254}
            PropertyChanges { target: photo1; opacity: 0}
            PropertyChanges { target: photo2; x: -194}
            PropertyChanges { target: photo2; opacity: 0}
            PropertyChanges { target: photo3; x: -194}
            PropertyChanges { target: photo3; opacity: 0}
            PropertyChanges { target: photo4; x: 740}
        ...
        State {
            ...
            PropertyChanges { target: photo4; x: 210}
