...
BasePage {
    ...
    states: [
        State {
            name: "DEFAULT"
            PropertyChanges { target: photo1; x: -310}
        ...
        State {
            ...
            PropertyChanges { target: photo2; x: 326}
            PropertyChanges { target: photo2; opacity: 1}
            PropertyChanges { target: photo3; x: 326}
            PropertyChanges { target: photo3; opacity: 1}
            PropertyChanges { target: photo4; x: 326}
            PropertyChanges { target: photo4; opacity: 1}
            PropertyChanges { target: photo5; y: 430}
            PropertyChanges { target: photo5; opacity: 1}
            PropertyChanges { target: photo6; y: 430}
            PropertyChanges { target: photo6; opacity: 1}
            PropertyChanges { target: photo7; y: 430}
